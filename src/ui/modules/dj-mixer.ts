  ...
  render() {
    return html`
      <div class="h-full w-full flex flex-col items-center p-2 md:p-2 overflow-hidden">
           ...
           <!-- CHANNELS (Grid layout, scrollable on mobile) -->
           <div class="flex-grow w-full grid grid-cols-2 gap-3 md:gap-2 min-h-0 overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-zinc-700/50 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-zinc-600 mb-2">
               <!-- DECK A STRIP -->
               <div class="rounded-2xl border border-tech-cyan/20 bg-black/30 p-3 md:p-2 flex flex-col items-center gap-2 md:gap-1 group hover:border-tech-cyan/40 transition-colors min-w-0">
                   <div class="text-sm md:text-xs font-mono text-tech-cyan tracking-widest font-bold">CH.A</div>
                   ...
                   <div class="flex gap-3 md:gap-2 w-full justify-center border-b-2 border-white/10 pb-3 md:pb-2 mb-2">
                       ...
                       <bio-slider label="DRV" .value="${this.driveA}" min="0" max="1" step="0.01" class="h-32 md:h-24"
               ...
               <div class="rounded-2xl border border-signal-emerald/20 bg-black/30 p-3 md:p-2 flex flex-col items-center gap-2 md:gap-1 group hover:border-signal-emerald/40 transition-colors min-w-0">
                   <div class="text-sm md:text-xs font-mono text-signal-emerald tracking-widest font-bold">CH.B</div>
                   ...
                   <div class="flex gap-3 md:gap-2 w-full justify-center border-b-2 border-white/10 pb-3 md:pb-2 mb-2">
                       ...
                       <bio-slider label="DRV" .value="${this.driveB}" min="0" max="1" step="0.01" class="h-32 md:h-24"
