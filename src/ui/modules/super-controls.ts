      ...
      <div class="container">
        ...
        <div class="panel">
           ...
           <div class="control-group">
               ...
               <select .value="${this.preferredVisual}" @change="${(e:any) => this.preferredVisual = e.target.value}">
                   <option value="organic">ORGANIC (Normal)</option>
                   <option value="wireframe">WIREFRAME</option>
                   <option value="monochrome">PARTICLES (Fluid)</option>
                   <option value="grid">GRID (Geometric)</option>
                   <option value="rings">RINGS (Dimension)</option>
                   <option value="waves">WAVES (Terrain)</option>
               </select>
           </div>
